...
export const InstallExtensionsToolData: IToolData = {
	...
	modelDescription: 'This is a tool for installing extensions in CodeeForge. You should provide the list of extension ids to install. The identifier of an extension is \'\${ publisher }.\${ name }\' for example: \'vscode.csharp\'.',
